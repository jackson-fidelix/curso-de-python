...
if num_escolhido == 1:
    print('\033[1;32mVocê escolhou a opção 1 e sua base Binária é {}! \033[m'.format(bin(num_inteiro)))
elif num_escolhido == 2:
    print('\033[1;33mVocê escolheu a opção 2 e sua base Octal é {}! \033[m'.format(oct(num_inteiro)))
elif num_escolhido == 3:
    print('\033[1;36mVocê escolheu a opção 3 e a sua base Hexadecimal é {}!\033[m'.format(hex(num_inteiro)))
else:
